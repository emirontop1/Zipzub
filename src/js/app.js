...
class XenonMaps {
    ...
    setupEventListeners() {
        ...
        if (clearMeasure) {
            clearMeasure.addEventListener('click', () => this.clearMeasurement());
        }
    }
...
// Global erişim için
window.xenonMaps = xenonMaps;        document.getElementById('shareBtn').addEventListener('click', () => this.shareLocation());
